...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    let displayNames = [];
    // For each animal object in array, push animal[animal name] and animal[scientific name] as string to displayNames
  ...
  */
  ...
  function lowerCaseNames(array){
    // map the value of animal_name from array using animal as the object and convert the value of animal_name to lowercase
    const animalNames = array.map((animal) => {
      return animal.animal_name.toLowerCase();
    });
    // return the newly created animalNames array
    return animalNames;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    // Create a new array lowPop using filter on array to only include all animals with a population less than 5
    const lowPop = array.filter((animal) => {
  ...
  */
  ...
  function USApop(array){
    // create a new variable equal the total of all animal populations in array
    const totalPop = array.reduce((total, animal) => {
